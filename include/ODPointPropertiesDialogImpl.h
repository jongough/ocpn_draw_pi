...
#ifndef __ODPointsPropertiesDialogImpl__
#define __ODPointsPropertiesDialogImpl__
...
/** Implementing ODPointPropertiesDialogImpl */
class ODPointPropertiesDialogImpl : public ODPointPropertiesDialogDef
{
protected:
...
public:
    /** Constructor */
    ODPointPropertiesDialogImpl( wxWindow* parent );
    virtual ~ODPointPropertiesDialogImpl();
