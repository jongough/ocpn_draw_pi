...
enum { EXCLUSION_BOUNDARY = 0, INCLUSION_BOUNDARY, NEITHER_BOUNDARY };
...
enum { TEXTPOINT_TEXT_BACKGROUND_TRANSPARANCY_DEFAULT = -1 };

struct ODAPIVersion_t {
  int ODAPIVersionMajor;
  int ODAPIVersionMinor;
  ODAPIVersion_t()
      : ODAPIVersionMajor(ODAPI_VERSION_MAJOR),
        ODAPIVersionMinor(ODAPI_VERSION_MINOR) {}
};
