...
elseif(UNIX)
    ...
    if("$ENV{BUILD_ENV}" STREQUAL "debian" OR "$ENV{BUILD_ENV}" STREQUAL "DEBIAN")
        ...
        message(STATUS "${CMLOC}PKG_TARGET_WX_VER: ${PKG_TARGET_WX_VER}, WX_VER: $ENV{WX_VER}")
    elseif("$ENV{BUILD_ENV}" STREQUAL "ubuntu" OR "$ENV{BUILD_ENV}" STREQUAL "UBUNTU")
        if("$ENV{OCPN_TARGET}" STREQUAL "jammy" OR "$ENV{OCPN_TARGET}" STREQUAL "JAMMY")
            set(PKG_TARGET "$ENV{BUILD_ENV}")
            if( NOT "$ENV{WX_VER}" STREQUAL "" )
                set(PKG_TARGET_WX_VER "-wx$ENV{WX_VER}")
            endif()
...
if(NOT WIN32 AND NOT QT_ANDROID)
    ...
    if(UNIX AND NOT APPLE)
        ...
        if(EXISTS /etc/debian_version)
            ...
            set(PACKAGE_DEPS "libc6, libwxgtk3.0-0, wx-i18n, libglu1-mesa (>= 7.0.0), libgl1-mesa-glx (>= 7.0.0), zlib1g, bzip2, libportaudio2")
