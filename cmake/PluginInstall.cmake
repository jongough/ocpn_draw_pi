...
IF(WIN32)
  ...
  ENDIF(${BUNDLE_DATA} AND EXISTS ${PROJECT_SOURCE_DIR}/data)

  IF(${BUNDLE_DATA} AND EXISTS ${PROJECT_SOURCE_DIR}/images)
    INSTALL(DIRECTORY images DESTINATION "${INSTALL_DIRECTORY}")
  ENDIF(${BUNDLE_DATA} AND EXISTS ${PROJECT_SOURCE_DIR}/images)
ENDIF(WIN32)
...
IF(UNIX AND NOT APPLE)
 ...
 IF(${BUNDLE_DATA} AND EXISTS ${PROJECT_SOURCE_DIR}/data)
  ...
  IF(${BUNDLE_DATA} AND EXISTS ${PROJECT_SOURCE_DIR}/images)
    INSTALL(DIRECTORY images DESTINATION ${PREFIX_PARENTDATA}/plugins/${PACKAGE_NAME})
  ENDIF(${BUNDLE_DATA} AND EXISTS ${PROJECT_SOURCE_DIR}/images)
ENDIF(UNIX AND NOT APPLE)

SET(PREFIX_PKGDATA ${PREFIX_DATA}/OCPNDraw)

FILE(MAKE_DIRECTORY ${PREFIX_PKGDATA})
FILE(MAKE_DIRECTORY ${PREFIX_PKGDATA}/data)
FILE(MAKE_DIRECTORY ${PREFIX_PKGDATA}/images)
INSTALL(DIRECTORY images DESTINATION ${PREFIX_PKGDATA}/. DIRECTORY_PERMISSIONS OWNER_READ OWNER_WRITE GROUP_READ WORLD_READ )
