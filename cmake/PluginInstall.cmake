...
# assuming wxwidgets is compiled with unicode, this is needed for mingw headers
  ...
  MESSAGE (STATUS "GLU_static : " ${OPENCPN_IMPORT_LIB})
ENDIF(WIN32)
...
MESSAGE(STATUS "PREFIX_LIB: ${PREFIX_LIB}")
...
IF(WIN32)
  ...
  IF(EXISTS ${PROJECT_SOURCE_DIR}/UserIcons)
    ...
    LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CreateDirectory \\\"$APPDATA\\\\opencpn\\\\plugins\\\\ocpn_draw_pi\\\\UserIcons\\\"")
    LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "CopyFiles \\\"$INSTDIR\\\\plugins\\\\ocpn_draw_pi\\\\UserIcons\\\\*.*\\\" \\\"$APPDATA\\\\opencpn\\\\plugins\\\\ocpn_draw_pi\\\\UserIcons\\\\\\\"")
    LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "Delete \\\"$INSTDIR\\\\plugins\\\\ocpn_draw_pi\\\\UserIcons\\\\*.*\\\"")
    LIST(APPEND CPACK_NSIS_EXTRA_INSTALL_COMMANDS "RMDir \\\"$INSTDIR\\\\plugins\\\\ocpn_draw_pi\\\\UserIcons\\\"")
...
MESSAGE (STATUS "Install Target: ${PREFIX_PARENTLIB}")
