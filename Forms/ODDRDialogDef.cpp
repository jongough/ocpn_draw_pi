...
MyDialogDR::MyDialogDR( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticTextLength = new wxStaticText( this, wxID_ANY, _("Length"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticTextWaypointInterval = new wxStaticText( this, wxID_ANY, _("Waypoint Interval"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticTextWaypointInterval->Wrap( -1 );
	fgSizer6->Add( m_staticTextWaypointInterval, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_textCtrlWaypointInterval = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer6->Add( m_textCtrlWaypointInterval, 0, wxALL, 5 );
	...
	m_radioBoxLengthType->SetSelection( 0 );
	...
	m_radioBoxIntervalType->SetSelection( 0 );
	...
	wxString m_radioBoxDistanceChoices[] = { _("Feet"), _("Meters"), _("Kilometers"), _("Statute Miles"), _("Nautical Miles") };
	int m_radioBoxDistanceNChoices = sizeof( m_radioBoxDistanceChoices ) / sizeof( wxString );
	m_radioBoxDistance = new wxRadioBox( this, wxID_ANY, _("Distance Units"), wxDefaultPosition, wxDefaultSize, m_radioBoxDistanceNChoices, m_radioBoxDistanceChoices, 1, wxRA_SPECIFY_ROWS );
	m_radioBoxDistance->SetSelection( 4 );
	fgSizerIntervalType->Add( m_radioBoxDistance, 0, wxALL, 5 );
	
	wxString m_radioBoxTimeUnitsChoices[] = { _("Seconds"), _("Minutes"), _("Hours"), _("Days") };
	...
	m_radioBoxTimeUnits->SetSelection( 1 );
	...
	// Connect Events
	m_buttonOK->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialogDR::OnOK ), NULL, this );
	m_buttonCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialogDR::OnCancel ), NULL, this );
}

MyDialogDR::~MyDialogDR()
{
	// Disconnect Events
	m_buttonOK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialogDR::OnOK ), NULL, this );
	m_buttonCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialogDR::OnCancel ), NULL, this );
