...
ODPropertiesDialogImpl::ODPropertiesDialogImpl(wxWindow* parent) {
  ...
  wxSizerItem* l_sizerItem = m_fgSizerBoundarySettingsColours->GetItem(
      m_colourPickerActiveBoundaryLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerBoundarySettingsColours->GetItem(
      m_colourPickerActiveBoundaryFillColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerBoundarySettingsColours->GetItem(
      m_colourPickerInActiveBoundaryLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerBoundarySettingsColours->GetItem(
      m_colourPickerInActiveBoundaryFillColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerRingsDetail->GetItem(m_colourPickerODPointRangeRingColours);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerPositionAndColour->GetItem(m_colourPickerTextColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerPositionAndColour->GetItem(m_colourPickerBackgroundColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerPathSettings->GetItem(m_colourPickerActivePathLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerPathSettings->GetItem(m_colourPickerInActivePathLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerEBLSettings->GetItem(m_colourPickerActiveEBLLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerEBLSettings->GetItem(m_colourPickerInActiveEBLLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerDRDefaultSizes->GetItem(m_colourPickerDRLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerDRDefaultSizes->GetItem(m_colourPickerInActiveDRLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerDRPointSettings->GetItem(m_colourPickerDRPointRangeRingColours);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerGZSettingsColours->GetItem(m_colourPickerActiveGZLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerGZSettingsColours->GetItem(m_colourPickerActiveGZFillColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerGZSettingsColours->GetItem(m_colourPickerInActiveGZLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerGZSettingsColours->GetItem(m_colourPickerInActiveGZFillColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem =
      m_fgSizerPILLineDetails->GetItem(m_colourPickerPILActiveCentreLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerPILLineDetails->GetItem(
      m_colourPickerPILInActiveCentreLineColour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerPILLineDetails->GetItem(
      m_colourPickerPILActiveOffsetLine1Colour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerPILLineDetails->GetItem(
      m_colourPickerPILInActiveOffsetLine1Colour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerPILLineDetails->GetItem(
      m_colourPickerPILActiveOffsetLine2Colour);
  l_sizerItem->SetFlag(wxEXPAND);
  l_sizerItem = m_fgSizerPILLineDetails->GetItem(
      m_colourPickerPILInactiveOffsetLine2Colour);
  l_sizerItem->SetFlag(wxEXPAND);

#endif

  wxString l_sTitle;
  l_sTitle.Printf(wxT("%s v%d.%d.%d.%d %s"),
                  g_ocpn_draw_display_name->ToStdString(), PLUGIN_VERSION_MAJOR,
                  PLUGIN_VERSION_MINOR, PLUGIN_VERSION_PATCH,
                  PLUGIN_VERSION_TWEAK, ("Preferences"));
  SetTitle(l_sTitle);
  ...
  m_staticTextMajorVal->SetLabel(
      wxString::Format(wxT("%i"), PLUGIN_VERSION_MAJOR));
  m_staticTextMinorVal->SetLabel(
      wxString::Format(wxT("%i"), PLUGIN_VERSION_MINOR));
  ...
  m_staticTextOCPNAPIVersionMajorVal->SetLabel(
      wxT(TOSTRING(OCPN_API_VERSION_MAJOR)));
  m_staticTextOCPNAPIVersionMinorVal->SetLabel(
      wxT(TOSTRING(OCPN_API_VERSION_MINOR)));
...
#if wxCHECK_VERSION(3, 0, 0)
  wxFloatingPointValidator<double> dODPointRangeRingStepVal(
      3, &m_dODPointRangeRingStepValidator, wxNUM_VAL_DEFAULT);
  wxFloatingPointValidator<double> dODPointArrivalRadiusVal(
      3, &m_dODPointArrivalRadiusValidator, wxNUM_VAL_DEFAULT);
  wxFloatingPointValidator<double> dDRPathLengthVal(
      3, &m_dDRPathLengthValidator, wxNUM_VAL_DEFAULT);
  wxFloatingPointValidator<double> dDRPointIntervalVal(
      3, &m_dODPointIntervalValidator, wxNUM_VAL_DEFAULT);
  wxFloatingPointValidator<double> dDRPointRangeRingStepVal(
      3, &m_dDRPointRangRingStepValidator, wxNUM_VAL_DEFAULT);
  wxFloatingPointValidator<double> dSOGVal(3, &m_dSOGValidator,
                                           wxNUM_VAL_DEFAULT);
  wxFloatingPointValidator<double> dPILOffset(3, &m_dPILOffsetValidator,
                                              wxNUM_VAL_DEFAULT);
  wxIntegerValidator<int> iCOGVal(&m_iCOGValidator, wxNUM_VAL_DEFAULT);
  wxIntegerValidator<int> iTextPointTextMaxWidth(&m_iTextPointTextMaxWidth,
  ...
  if (l_iPage != wxNOT_FOUND) m_notebookProperties->DeletePage(l_iPage);
#else
  ...
  // Boundary point Icon
  m_bODIComboBoxODPointIconName =
      new ODIconCombo(m_panelBoundaryPoint, wxID_ANY, _("Combo!"),
  ...
  // m_SizerNameIcon->Add(m_bODIComboBoxODPointIconName, 1,
  // wxALIGN_RIGHT|wxALL|wxEXPAND, 5 );
  m_fgSizerODPointIcon->Replace(m_bcomboBoxODPointIconName,
                                m_bODIComboBoxODPointIconName);

  // Textpoint Icon
  m_bODIComboBoxTextPointIconName =
      new ODIconCombo(m_panelTextPoint, wxID_ANY, _("Combo!"),
                      wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_READONLY);
  m_bODIComboBoxTextPointIconName->SetPopupMaxHeight(::wxGetDisplaySize().y /
                                                     2);

  //  Accomodate scaling of icon
  // min_size = wxMax( min_size, (32 *g_ChartScaleFactorExp) + 4 );
  m_bODIComboBoxTextPointIconName->SetMinSize(wxSize(-1, min_size));
  m_fgSizerTextPointIconName->Replace(m_bcomboBoxTextPointIconName,
                                      m_bODIComboBoxTextPointIconName);

  // EBL Start point Icon
  m_bODIComboBoxEBLStartIconName =
      new ODIconCombo(m_panelEBL, wxID_ANY, _("Combo!"), wxDefaultPosition,
  ...
  m_fgSizerEBLStartIconName->Replace(m_bcomboBoxEBLStartIconName,
                                     m_bODIComboBoxEBLStartIconName);

  // EBL End point Icon
  m_bODIComboBoxEBLEndIconName =
      new ODIconCombo(m_panelEBL, wxID_ANY, _("Combo!"), wxDefaultPosition,
                      wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  m_fgSizerEBLEndPointIcon->Replace(m_bcomboBoxEBLEndIconName,
                                    m_bODIComboBoxEBLEndIconName);

  // DR point Icon
  m_bODIComboBoxDRPointIconName =
      new ODIconCombo(m_panelDRPoint, wxID_ANY, _("Combo!"), wxDefaultPosition,
                      wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  m_fgSizerDRPointSettings->Replace(m_bcomboBoxDRPointIconName,
                                    m_bODIComboBoxDRPointIconName);

  // GZ First point Icon
  m_bODIComboBoxGZFirstIconName =
      new ODIconCombo(m_panelGZ, wxID_ANY, _("Combo!"), wxDefaultPosition,
                      wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  m_fgSizerGZFASIcon->Replace(m_bcomboBoxGZFirstIconName,
                              m_bODIComboBoxGZFirstIconName);

  // GZ End point Icon
  m_bODIComboBoxGZSecondIconName =
      new ODIconCombo(m_panelGZ, wxID_ANY, _("Combo!"), wxDefaultPosition,
                      wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  m_fgSizerGZFASIcon->Replace(m_bcomboBoxGZSecondIconName,
                              m_bODIComboBoxGZSecondIconName);

  // PIL Start point Icon
  m_bODIComboBoxPILStartIconName =
      new ODIconCombo(m_panelPIL, wxID_ANY, _("Combo!"), wxDefaultPosition,
                      wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  fgSizerPILDefaults->Replace(m_bcomboBoxPILStartIconName,
                              m_bODIComboBoxPILStartIconName);

  // PIL End point Icon
  m_bODIComboBoxPILEndIconName =
      new ODIconCombo(m_panelPIL, wxID_ANY, _("Combo!"), wxDefaultPosition,
                      wxDefaultSize, 0, NULL, wxCB_READONLY);
  ...
  fgSizerPILDefaults->Replace(m_bcomboBoxPILEndIconName,
                              m_bODIComboBoxPILEndIconName);
...
void ODPropertiesDialogImpl::OnTextPointIconComboboxSelected(
    wxCommandEvent& event) {}

void ODPropertiesDialogImpl::OnEBLEndIconComboboxSelected(
    wxCommandEvent& event) {}

void ODPropertiesDialogImpl::OnEBLStartIconComboboxSelected(
    wxCommandEvent& event) {}

void ODPropertiesDialogImpl::OnDRPointIconComboboxSelected(
    wxCommandEvent& event) {}

void ODPropertiesDialogImpl::OnGZFirstIconComboboxSelected(
    wxCommandEvent& event) {}

void ODPropertiesDialogImpl::OnGZSecondIconComboboxSelected(
    wxCommandEvent& event) {}
...
void ODPropertiesDialogImpl::OnButtonClickFonts(wxCommandEvent& event) {
  ...
  if (iRet == wxID_OK) {
    ...
    m_staticTextFontFaceExample->SetFont(
        m_pfdDialog->GetFontData().GetChosenFont());
    m_fgSizerTextPointFont->RecalcSizes();
    m_panelTextPoint->Layout();
    SendSizeEvent();
#if wxCHECK_VERSION(3, 0, 0)
    m_notebookProperties->SetSelection(
        m_notebookProperties->FindPage(m_panelTextPoint));
#else
...
void ODPropertiesDialogImpl::OnDrawPropertiesCancelClick(
    wxCommandEvent& event) {
  Show(false);
  // #ifdef __WXOSX__
...
void ODPropertiesDialogImpl::SaveChanges() {
  ...
  // g_colourActiveBoundaryLineColour =
  // PickerODPointRangeRingColours->GetColour();
  g_colourActiveBoundaryLineColour =
      m_colourPickerActiveBoundaryLineColour->GetColour();
  g_colourActiveBoundaryFillColour =
      m_colourPickerActiveBoundaryFillColour->GetColour();
  g_colourInActiveBoundaryLineColour =
      m_colourPickerInActiveBoundaryLineColour->GetColour();
  g_colourInActiveBoundaryFillColour =
      m_colourPickerInActiveBoundaryFillColour->GetColour();

  g_BoundaryLineWidth =
      ::WidthValues[m_choiceBoundaryLineWidth->GetSelection()];
  g_BoundaryLineStyle =
      (wxPenStyle)::StyleValues[m_choiceBoundaryLineStyle->GetSelection()];
  g_uiFillTransparency = m_sliderFillTransparency->GetValue();
  g_uiBoundaryPointFillTransparency =
      m_sliderBoundaryPointFillTransparency->GetValue();
  g_iBoundaryPointRangeRingLineWidth =
      ::WidthValues[m_choiceRangeRingWidth->GetSelection()];
  g_iBoundaryPointRangeRingLineStyle =
      (wxPenStyle)::StyleValues[m_choiceRangeRingStyle->GetSelection()];
  g_iInclusionBoundarySize = m_sliderInclusionBoundarySize->GetValue();
  g_iInclusionBoundaryPointSize =
      m_sliderInclusionBoundaryPointSize->GetValue();
  ...
  //    g_colourActivePathLineColour =
  //    m_colourPickerActivePathLineColour->GetColour();
  //    g_colourInActivePathLineColour =
  //    m_colourPickerInActivePathLineColour->GetColour();

  //    g_PathLineWidth = ::WidthValues[ m_choicePathLineWidth->GetSelection()
  //    ]; g_PathLineStyle = ::StyleValues[
  //    m_choicePathLineStyle->GetSelection()];
  ...
  g_EBLLineStyle =
      (wxPenStyle)::StyleValues[m_choiceEBLLineStyle->GetSelection()];
  ...
  g_colourPILActiveCentreLineColour =
      m_colourPickerPILActiveCentreLineColour->GetColour();
  g_colourPILInActiveCentreLineColour =
      m_colourPickerPILInActiveCentreLineColour->GetColour();
  g_colourPILActiveOffsetLine1Colour =
      m_colourPickerPILActiveOffsetLine1Colour->GetColour();
  g_colourPILInActiveOffsetLine1Colour =
      m_colourPickerPILInActiveOffsetLine1Colour->GetColour();
  g_colourPILActiveOffsetLine2Colour =
      m_colourPickerPILActiveOffsetLine2Colour->GetColour();
  g_colourPILInActiveOffsetLine2Colour =
      m_colourPickerPILInactiveOffsetLine2Colour->GetColour();
  g_PILCentreLineWidth =
      ::WidthValues[m_choicePILCentreLineWidth->GetSelection()];
  g_PILCentreLineStyle =
      (wxPenStyle)::StyleValues[m_choicePILCentreLineStyle->GetSelection()];
  g_PILOffsetLine1Width =
      ::WidthValues[m_choicePILOffsetLine1Width->GetSelection()];
  g_PILOffsetLine1Style =
      (wxPenStyle)::StyleValues[m_choicePILOffsetLine1Style->GetSelection()];
  g_PILOffsetLine2Width =
      ::WidthValues[m_choicePILOffsetLine2Width->GetSelection()];
  g_PILOffsetLine2Style =
      (wxPenStyle)::StyleValues[m_choicePILOffsetLine2Style->GetSelection()];
  ...
  g_colourInActiveDRLineColour =
      m_colourPickerInActiveDRLineColour->GetColour();
  g_DRLineWidth = ::WidthValues[m_choiceDRLineWidth->GetSelection()];
  g_DRLineStyle =
      (wxPenStyle)::StyleValues[m_choiceDRLineStyle->GetSelection()];
  ...
  g_colourDRPointRangeRingsColour =
      m_colourPickerDRPointRangeRingColours->GetColour();
  g_iDRPointRangeRingLineWidth =
      ::WidthValues[m_choiceDRPointRangeRingWidth->GetSelection()];
  g_iDRPointRangeRingLineStyle =
      (wxPenStyle)::StyleValues[m_choiceDRPointRangeRingStyle->GetSelection()];
  ...
  g_colourInActiveGZLineColour =
      m_colourPickerInActiveGZLineColour->GetColour();
  g_colourInActiveGZFillColour =
      m_colourPickerInActiveGZFillColour->GetColour();
  g_GZLineWidth = ::WidthValues[m_choiceGZLineWidth->GetSelection()];
  g_GZLineStyle =
      (wxPenStyle)::StyleValues[m_choiceGZLineStyle->GetSelection()];
  ...
  g_colourODPointRangeRingsColour =
      m_colourPickerODPointRangeRingColours->GetColour();
  ...
  g_bRememberPropertyDialogPosition =
      m_checkBoxRememberPropertyPosition->GetValue();
  ...
  g_colourDefaultTextBackgroundColour =
      m_colourPickerBackgroundColour->GetColour();
...
void ODPropertiesDialogImpl::SetDialogSize(void) {
#if wxCHECK_VERSION(3, 0, 0)
  m_notebookProperties->SetSelection(
      m_notebookProperties->FindPage(m_panelGeneral));
#else
  ...
  m_panelGeneral->SetMinClientSize(
      m_bSizerGeneral->ComputeFittingClientSize(this));
  m_panelBoundary->SetMinClientSize(
      m_fgSizerBoundarySettings->ComputeFittingClientSize(this));
  m_panelBoundaryPoint->SetMinClientSize(
      m_bSizerOCPNPoint->ComputeFittingClientSize(this));
  m_panelTextPoint->SetMinClientSize(
      m_fgSizerTextPoint->ComputeFittingClientSize(this));
  m_panelEBL->SetMinClientSize(
      m_fgSizerEBLSettings->ComputeFittingClientSize(this));
  m_panelDR->SetMinClientSize(
      m_fgSizerDRSettings->ComputeFittingClientSize(this));
  m_panelDRPoint->SetMinClientSize(
      m_fgSizerDRPointSettings->ComputeFittingClientSize(this));
  m_panelGZ->SetMinClientSize(
      m_fgSizerGZSettings->ComputeFittingClientSize(this));
  m_panelPIL->SetMinClientSize(
      m_fgSizerPILSettings->ComputeFittingClientSize(this));
  ...
  m_panelLicense->SetMinClientSize(
      m_fgSizerLicense->ComputeFittingClientSize(this));
...
void ODPropertiesDialogImpl::UpdateProperties(void) {
  ...
  // m_textCtrlODPointRangeRingSteps->SetValue( wxString::Format( wxT("%.3f"),
  // g_fODPointRangeRingsStep ) );
  m_choiceODPointDistanceUnit->SetSelection(g_iODPointRangeRingsStepUnits);
  m_colourPickerODPointRangeRingColours->SetColour(
      g_colourODPointRangeRingsColour);

  m_sliderBoundaryPointFillTransparency->SetValue(
      g_uiBoundaryPointFillTransparency);
  m_sliderInclusionBoundaryPointSize->SetValue(g_iInclusionBoundaryPointSize);

  if (g_bExclusionBoundaryPoint && !g_bInclusionBoundaryPoint)
    m_radioBoxBoundaryPointType->SetSelection(ID_BOUNDARY_EXCLUSION);
  else if (!g_bExclusionBoundaryPoint && g_bInclusionBoundaryPoint)
    m_radioBoxBoundaryPointType->SetSelection(ID_BOUNDARY_INCLUSION);
  else if (!g_bExclusionBoundaryPoint && !g_bInclusionBoundaryPoint)
    m_radioBoxBoundaryPointType->SetSelection(ID_BOUNDARY_NEITHER);
  else
    m_radioBoxBoundaryPointType->SetSelection(ID_BOUNDARY_EXCLUSION);
  ...
  //  not found, so add  it to the list, with a generic bitmap and using the
  //  name as description
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxODPointIconName->Append(g_sODPointIconName,
                                          icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxTextPointIconName->Append(g_sTextPointIconName,
                                            icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxEBLEndIconName->Append(g_sEBLEndIconName,
                                         icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxEBLStartIconName->Append(g_sEBLStartIconName,
                                           icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxDRPointIconName->Append(g_sDRPointIconName,
                                          icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxGZFirstIconName->Append(g_sGZFirstIconName,
                                          icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxGZSecondIconName->Append(g_sGZSecondIconName,
                                           icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxPILEndIconName->Append(g_sPILEndIconName,
                                         icons->GetBitmap(0));
  ...
  // n.b.  This should never happen...
  if (-1 == iconToSelect) {
    m_bODIComboBoxPILStartIconName->Append(g_sPILStartIconName,
                                           icons->GetBitmap(0));
  ...
  m_colourPickerActiveBoundaryLineColour->SetColour(
      g_colourActiveBoundaryLineColour);
  m_colourPickerInActiveBoundaryLineColour->SetColour(
      g_colourInActiveBoundaryLineColour);
  m_colourPickerActiveBoundaryFillColour->SetColour(
      g_colourActiveBoundaryFillColour);
  m_colourPickerInActiveBoundaryFillColour->SetColour(
      g_colourInActiveBoundaryFillColour);

  // m_colourPickerActivePathLineColour->SetColour(
  // g_colourActivePathLineColour );
  // m_colourPickerInActivePathLineColour->SetColour(
  // g_colourInActivePathLineColour );
  ...
  for (unsigned int i = 0; i < sizeof(::StyleValues) / sizeof(int); i++) {
    ...
    if (g_DRLineStyle == ::StyleValues[i]) m_choiceDRLineStyle->SetSelection(i);
    if (g_GZLineStyle == ::StyleValues[i]) m_choiceGZLineStyle->SetSelection(i);
  ...
  for (unsigned int i = 0; i < sizeof(::WidthValues) / sizeof(int); i++) {
    ...
    if (g_DRLineWidth == ::WidthValues[i]) m_choiceDRLineWidth->SetSelection(i);
    if (g_GZLineWidth == ::WidthValues[i]) m_choiceGZLineWidth->SetSelection(i);
  ...
  if (g_bExclusionBoundary && !g_bInclusionBoundary)
    m_radioBoxBoundaryType->SetSelection(ID_BOUNDARY_EXCLUSION);
  else if (!g_bExclusionBoundary && g_bInclusionBoundary)
    m_radioBoxBoundaryType->SetSelection(ID_BOUNDARY_INCLUSION);
  else if (!g_bExclusionBoundary && !g_bInclusionBoundary)
    m_radioBoxBoundaryType->SetSelection(ID_BOUNDARY_NEITHER);
  else
    m_radioBoxBoundaryType->SetSelection(ID_BOUNDARY_EXCLUSION);
  ...
  m_colourPickerPILActiveCentreLineColour->SetColour(
      g_colourPILActiveCentreLineColour);
  m_colourPickerPILInActiveCentreLineColour->SetColour(
      g_colourPILInActiveCentreLineColour);
  m_colourPickerPILActiveOffsetLine1Colour->SetColour(
      g_colourPILActiveOffsetLine1Colour);
  m_colourPickerPILInActiveOffsetLine1Colour->SetColour(
      g_colourPILInActiveOffsetLine1Colour);
  m_colourPickerPILActiveOffsetLine2Colour->SetColour(
      g_colourPILActiveOffsetLine2Colour);
  m_colourPickerPILInactiveOffsetLine2Colour->SetColour(
      g_colourPILInActiveOffsetLine2Colour);
  ...
  m_colourPickerBackgroundColour->SetColour(
      g_colourDefaultTextBackgroundColour);
  ...
  m_checkBoxRememberPropertyPosition->SetValue(
      g_bRememberPropertyDialogPosition);
  ...
  m_colourPickerDRPointRangeRingColours->SetColour(
      g_colourDRPointRangeRingsColour);
...
void ODPropertiesDialogImpl::OnRestoreLayerVisabilityClicked(
    wxCommandEvent& event) {
