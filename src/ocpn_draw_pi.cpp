...
//
//---------------------------------------------------------------------------------------------------------
ocpn_draw_pi::ocpn_draw_pi(void* ppimgr) : opencpn_plugin_118(ppimgr) {
  ...
  appendOSDirSlash(l_pDir);
  if (!wxDir::Exists(*l_pDir)) wxMkdir(*l_pDir);
  ...
  if (!wxDir::Exists(*g_pData)) wxMkdir(*g_pData);
...
int ocpn_draw_pi::Init(void) {
  ...
  g_pODConfig->m_pODNavObjectChangesSet =
      new ODNavObjectChanges(g_pODConfig->m_sODNavObjSetChangesFile);
  //    g_pODConfig->m_pODNavObjectChangesSet = new ODNavObjectChanges(
  //    wxS("/home/jon/.opencpn/odnavobj.xml.changes") );
  ...
  if (m_bLOGShowIcon) {
#ifdef ODraw_USE_SVG
    m_config_button_id = InsertPlugInToolSVG(
        _("OCPN Draw Manager"), m_pODicons->m_s_ocpn_draw_pi,
        m_pODicons->m_s_ocpn_draw_pi, m_pODicons->m_s_ocpn_draw_grey_pi,
        wxITEM_CHECK, _("OCPN Draw Manager"), wxS(""), NULL, OCPN_DRAW_POSITION,
        0, this);
    m_draw_button_id = InsertPlugInToolSVG(
        _("OCPN Draw Boundary"), m_pODicons->m_s_ocpn_draw_boundary,
        m_pODicons->m_s_ocpn_draw_boundary,
        m_pODicons->m_s_ocpn_draw_boundary_grey, wxITEM_CHECK, _("OCPN Draw"),
        wxS(""), NULL, OCPN_DRAW_POSITION, 0, this);
#else
    m_config_button_id = InsertPlugInTool(
        _("OCPN Draw Manager"), m_pODicons->m_p_bm_ocpn_draw_grey_pi,
        m_pODicons->m_p_bm_ocpn_draw_pi, wxITEM_NORMAL, _("OCPN Draw Manager"),
        wxS(""), NULL, OCPN_DRAW_POSITION, 0, this);
    m_draw_button_id = InsertPlugInTool(
        _("OCPN Draw Boundary"), m_pODicons->m_p_bm_ocpn_draw_boundary_grey,
        m_pODicons->m_p_bm_ocpn_draw_boundary, wxITEM_CHECK, _("OCPN Draw"),
        wxS(""), NULL, OCPN_DRAW_POSITION, 0, this);
#endif
  }
  ...
  switch (m_Mode) {
    case ID_MODE_BOUNDARY:
      // Boundary
#ifdef ODraw_USE_SVG
      SetToolbarToolBitmapsSVG(m_draw_button_id,
                               m_pODicons->m_s_ocpn_draw_boundary,
                               m_pODicons->m_s_ocpn_draw_boundary,
                               m_pODicons->m_s_ocpn_draw_boundary_grey);
#else
      SetToolbarToolBitmaps(m_draw_button_id,
                            m_pODicons->m_p_bm_ocpn_draw_boundary_grey,
                            m_pODicons->m_p_bm_ocpn_draw_boundary);
#endif
      break;
...
#ifdef ODraw_USE_SVG
      SetToolbarToolBitmapsSVG(m_draw_button_id,
                               m_pODicons->m_s_ocpn_draw_point,
                               m_pODicons->m_s_ocpn_draw_point,
                               m_pODicons->m_s_ocpn_draw_point_grey);
#else
      SetToolbarToolBitmaps(m_draw_button_id,
                            m_pODicons->m_p_bm_ocpn_draw_point_grey,
                            m_pODicons->m_p_bm_ocpn_draw_point);
#endif
      break;
...
#ifdef ODraw_USE_SVG
      SetToolbarToolBitmapsSVG(m_draw_button_id,
                               m_pODicons->m_s_ocpn_draw_textpoint,
                               m_pODicons->m_s_ocpn_draw_textpoint,
                               m_pODicons->m_s_ocpn_draw_textpoint_grey);
#else
      SetToolbarToolBitmaps(m_draw_button_id,
                            m_pODicons->m_p_bm_ocpn_draw_textpoint_grey,
                            m_pODicons->m_p_bm_ocpn_draw_textpoint);
#endif
      break;
    ...
    case ID_MODE_EBL:
      // EBL
#ifdef ODraw_USE_SVG
      SetToolbarToolBitmapsSVG(m_draw_button_id, m_pODicons->m_s_ocpn_draw_ebl,
                               m_pODicons->m_s_ocpn_draw_ebl,
                               m_pODicons->m_s_ocpn_draw_ebl_grey);
#else
      SetToolbarToolBitmaps(m_draw_button_id,
                            m_pODicons->m_p_bm_ocpn_draw_ebl_grey,
                            m_pODicons->m_p_bm_ocpn_draw_ebl);
#endif
      break;
    ...
    case ID_MODE_DR:
      // DR
#ifdef ODraw_USE_SVG
      SetToolbarToolBitmapsSVG(m_draw_button_id, m_pODicons->m_s_ocpn_draw_dr,
                               m_pODicons->m_s_ocpn_draw_dr,
                               m_pODicons->m_s_ocpn_draw_dr_grey);
#else
      SetToolbarToolBitmaps(m_draw_button_id,
                            m_pODicons->m_p_bm_ocpn_draw_dr_grey,
                            m_pODicons->m_p_bm_ocpn_draw_dr);
#endif
      break;
    ...
    case ID_MODE_GZ:
      // GZ
#ifdef ODraw_USE_SVG
      SetToolbarToolBitmapsSVG(m_draw_button_id, m_pODicons->m_s_ocpn_draw_gz,
                               m_pODicons->m_s_ocpn_draw_gz,
                               m_pODicons->m_s_ocpn_draw_gz_grey);
#else
      SetToolbarToolBitmaps(m_draw_button_id,
                            m_pODicons->m_p_bm_ocpn_draw_gz_grey,
                            m_pODicons->m_p_bm_ocpn_draw_gz);
#endif
      break;
...
// PIL
#ifdef ODraw_USE_SVG
      SetToolbarToolBitmapsSVG(m_draw_button_id, m_pODicons->m_s_ocpn_draw_pil,
                               m_pODicons->m_s_ocpn_draw_pil,
                               m_pODicons->m_s_ocpn_draw_pil_grey);
#else
      SetToolbarToolBitmaps(m_draw_button_id,
                            m_pODicons->m_p_bm_ocpn_draw_pil_grey,
                            m_pODicons->m_p_bm_ocpn_draw_pil);
#endif
      break;
...
#ifdef __WXOSX__
  g_pODToolbar = new ODToolbarImpl(
      m_parent_window, wxID_ANY, _("Draw Toolbar"), wxDefaultPosition,
      wxDefaultSize, wxCAPTION | wxCLOSE_BOX | wxRESIZE_BORDER | wxSTAY_ON_TOP);
#else
  g_pODToolbar = new ODToolbarImpl(m_parent_window, wxID_ANY, _("Draw Toolbar"),
  ...
  g_pODToolbar->Bind(wxEVT_MENU, &ODToolbarImpl::OnToolButtonClick,
                     g_pODToolbar);
  ...
  m_pODToolContextMenuItem =
      new wxMenuItem(&dummy_menu, -1, _("Use OCPN Draw Tool"));
  ...
  m_RolloverPopupTimer->Bind(wxEVT_TIMER,
                             &ODEventHandler::OnRolloverPopupTimerEvent,
                             g_ODEventHandler);
...
#ifdef __WXMSW__
  // Hack similar to OCPN to handle wxmsw not supporting cursors bigger than
  // 32x32
  int l_xSize, l_ySize;
  wxDisplaySize(&l_xSize, &l_ySize);
  if (l_xSize > 3000) l_bUsePencilCrossCursor = false;
#endif
  // wxRect l_clientrect = this->GetGlientArea();
  wxImage ICursorPencil =
      m_pODicons
          ->ScaleIcon(GetIcon_PlugIn(_T("pencil")), m_pODicons->m_dScaleFactor)
          .ConvertToImage();
  ...
  wxImage ICursorCross =
      m_pODicons
          ->ScaleIcon(GetIcon_PlugIn(_T("cross")), m_pODicons->m_dScaleFactor)
          .ConvertToImage();
...
bool ocpn_draw_pi::DeInit(void) {
  ...
  if (m_BlinkTimer->IsRunning()) m_BlinkTimer->Stop();
  if (!m_BlinkTimer->Unbind(wxEVT_TIMER, &ODEventHandler::OnODTimer,
                            g_ODEventHandler)) {
  ...
  if (m_RolloverPopupTimer->IsRunning()) m_RolloverPopupTimer->Stop();
  if (!m_RolloverPopupTimer->Unbind(wxEVT_TIMER,
                                    &ODEventHandler::OnRolloverPopupTimerEvent,
                                    g_ODEventHandler)) {
  ...
  if (g_pODRolloverWin) DeleteWindow((wxWindow**)&g_pODRolloverWin);

  if (g_pODPointPropDialog) {
    g_iDefaultPointPropertyDialogPostionX =
        g_pODPointPropDialog->GetPosition().x;
    g_iDefaultPointPropertyDialogPostionY =
        g_pODPointPropDialog->GetPosition().y;
    DeleteWindow((wxWindow**)&g_pODPointPropDialog);
  }

  if (g_pBoundaryPropDialog) {
    g_iDefaultBoundaryPropertyDialogPostionX =
        g_pBoundaryPropDialog->GetPosition().x;
    g_iDefaultBoundaryPropertyDialogPostionY =
        g_pBoundaryPropDialog->GetPosition().y;
  ...
  if (g_PILIndexLinePropDialog) {
    g_iDefaultPILLinePropertyDialogPostionX =
        g_PILIndexLinePropDialog->GetPosition().x;
    g_iDefaultPILLinePropertyDialogPostionY =
        g_PILIndexLinePropDialog->GetPosition().y;
  ...
  if (g_pPathAndPointManagerDialog) {
    g_iDefaultPathAnPointManagerDialogPostionX =
        g_pPathAndPointManagerDialog->GetPosition().x;
    g_iDefaultPathAnPointManagerDialogPostionY =
        g_pPathAndPointManagerDialog->GetPosition().y;
    DeleteWindow((wxWindow**)&g_pPathAndPointManagerDialog);
  }

  if (g_pODToolbar) {
    g_pODToolbar->Unbind(wxEVT_MENU, &ODToolbarImpl::OnToolButtonClick,
                         g_pODToolbar);
    delete g_pODToolbar;
    g_pODToolbar = NULL;
  }
...
void ocpn_draw_pi::DeleteWindow(wxWindow* pWindow) {
  if (pWindow) {
    ...
    // delete pWindow;
#endif
    if ((wxWindow*)g_pODPathPropDialog == pWindow) g_pODPathPropDialog = NULL;
...
// delete pWindow;
#endif
    if (g_pODPathPropDialog == l_pWindow) g_pODPathPropDialog = NULL;
    *pWindow = NULL;
    return;
  }
}
...
int ocpn_draw_pi::GetPlugInVersionMajor() { return PLUGIN_VERSION_MAJOR; }

int ocpn_draw_pi::GetPlugInVersionMinor() { return PLUGIN_VERSION_MINOR; }

int ocpn_draw_pi::GetPlugInVersionPatch() { return PLUGIN_VERSION_PATCH; };

int ocpn_draw_pi::GetPlugInVersionPost() { return PLUGIN_VERSION_TWEAK; };

int ocpn_draw_pi::GetAPIVersionMajor() { return OCPN_API_VERSION_MAJOR; }

int ocpn_draw_pi::GetAPIVersionMinor() { return OCPN_API_VERSION_MINOR; }
wxString ocpn_draw_pi::GetCommonName() { return _T(PLUGIN_COMMON_NAME); }
...
void ocpn_draw_pi::SendVectorChartObjectInfo(wxString& chart, wxString& feature,
...
int ocpn_draw_pi::GetToolbarToolCount(void) { return 1; }
...
void ocpn_draw_pi::SetPositionFixEx(PlugIn_Position_Fix_Ex& pfix) {
  ...
  if (m_VP.bValid == false) return;

  bool l_bBoatChange = false;
  if (pfix.FixTime && pfix.nSats) m_LastFixTime = wxDateTime::Now();

  if (g_pfFix.valid && (g_pfFix.Lat != pfix.Lat || g_pfFix.Lon != pfix.Lon ||
                        (g_pfFix.Cog != pfix.Cog && !wxIsNaN(pfix.Cog)) ||
                        (g_pfFix.Hdt != pfix.Hdt && !wxIsNaN(pfix.Hdt))))
    l_bBoatChange = true;
  ...
  if (wxIsNaN(pfix.Cog)) {
    g_pfFix.validCog = false;
    if (g_pfFix.Cog != 0.) l_bBoatChange = true;
    g_pfFix.Cog = 0.;
  } else
    g_pfFix.Cog = pfix.Cog;
  if (wxIsNaN(pfix.Sog)) {
    if (g_pfFix.Sog != 0.) l_bBoatChange = true;
    g_pfFix.Sog = 0.;
  } else
  ...
  if (wxIsNaN(pfix.Hdm)) {
    g_pfFix.validHdm = true;
    if (g_pfFix.Hdm != 0.) l_bBoatChange = true;
    g_pfFix.Hdm = 0.;
  } else
  ...
  if (wxIsNaN(pfix.Hdt)) {
    g_pfFix.validHdt = false;
    if (g_pfFix.Hdt != 0.) l_bBoatChange = true;
    g_pfFix.Hdt = 0.;
  } else
...
void ocpn_draw_pi::OnToolbarToolDownCallback(int id) { ItemProcess(id); }

void ocpn_draw_pi::ItemProcess(int id) {
  m_iCallerId = id;
  if (m_Mode == ID_NONE) m_Mode = 0;

  if (NULL == g_pPathAndPointManagerDialog)  // There is one global instance of
                                             // the Dialog
    g_pPathAndPointManagerDialog =
        new PathAndPointManagerDialogImpl(m_parent_window);
...
void ocpn_draw_pi::SaveConfig() {
  ...
  if (pConf) {
    ...
    if (m_bRecreateConfig) {
      ...
      pConf->Write(wxS("DefaultBoundaryPointShowName"),
                   g_bBoundaryPointShowName);
      pConf->Write(wxS("DefaultActivePathLineColour"),
                   g_colourActivePathLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultInActivePathLineColour"),
          g_colourInActivePathLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultActiveBoundaryLineColour"),
          g_colourActiveBoundaryLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultInActiveBoundaryLineColour"),
          g_colourInActiveBoundaryLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultActiveBoundaryFillColour"),
          g_colourActiveBoundaryFillColour.GetAsString(wxC2S_CSS_SYNTAX));
      int l_BoundaryType;
      if (g_bExclusionBoundary && !g_bInclusionBoundary)
        l_BoundaryType = ID_BOUNDARY_EXCLUSION;
      else if (!g_bExclusionBoundary && g_bInclusionBoundary)
        l_BoundaryType = ID_BOUNDARY_INCLUSION;
      else if (!g_bExclusionBoundary && !g_bInclusionBoundary)
        l_BoundaryType = ID_BOUNDARY_NEITHER;
      else
        l_BoundaryType = ID_BOUNDARY_EXCLUSION;
      pConf->Write(wxS("DefaultBoundaryODPointsVisible"),
                   g_bBoundaryODPointsVisible);
      pConf->Write(wxS("DefaultBoundaryType"), l_BoundaryType);
      long l_longFillTransparency = g_uiFillTransparency;
      pConf->Write(wxS("DefaultBoundaryFillTransparency"),
                   l_longFillTransparency);
      pConf->Write(wxS("DefaultInclusionBoundarySize"),
                   g_iInclusionBoundarySize);
      pConf->Write(
          wxS("DefaultInActiveBoundaryFillColour"),
          g_colourInActiveBoundaryFillColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(wxS("DefaultGZFirstIcon"), g_sGZFirstIconName);
      pConf->Write(wxS("DefaultGZSecondIcon"), g_sGZSecondIconName);
      pConf->Write(wxS("DefaultActiveGZLineColour"),
                   g_colourActiveGZLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(wxS("DefaultInActiveGZLineColour"),
                   g_colourInActiveGZLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(wxS("DefaultActiveGZFillColour"),
                   g_colourActiveGZFillColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(wxS("DefaultInActiveGZFillColour"),
                   g_colourInActiveGZFillColour.GetAsString(wxC2S_CSS_SYNTAX));
      ...
      pConf->Write(wxS("DefaultEBLLineColour"),
                   g_colourEBLLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      ...
      pConf->Write(
          wxS("DefaultPILActiveCentreLineColour"),
          g_colourPILActiveCentreLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultPILInActiveCentreLineColour"),
          g_colourPILInActiveCentreLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultPILActiveOffsetLine1Colour"),
          g_colourPILActiveOffsetLine1Colour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultPILInActiveOffsetLine1Colour"),
          g_colourPILInActiveOffsetLine1Colour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultPILActiveOffsetLine2Colour"),
          g_colourPILActiveOffsetLine2Colour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultPILInActiveOffsetLine2Colour"),
          g_colourPILInActiveOffsetLine2Colour.GetAsString(wxC2S_CSS_SYNTAX));
      ...
      pConf->Write(wxS("DefaultShowDRPointRangeRings"),
                   g_bDRPointShowRangeRings);
      pConf->Write(wxS("DefaultDRPointRangeRingsNumber"),
                   g_iDRPointRangeRingsNumber);
      pConf->Write(wxS("DefaultDRPointRangeRingsStep"),
                   g_fDRPointRangeRingsStep);
      pConf->Write(wxS("DefaultDRPointRangeRingsStepUnits"),
                   g_iDRPointRangeRingsStepUnits);
      pConf->Write(
          wxS("DefaultDRPointRangeRingsColour"),
          g_colourDRPointRangeRingsColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(wxS("DefaultDRPointRangeRingLineWidth"),
                   g_iDRPointRangeRingLineWidth);
      pConf->Write(wxS("DefaultDRPointRangeRingLineStyle"),
                   (int)g_iDRPointRangeRingLineStyle);
      pConf->Write(wxS("DefaultDRLineColour"),
                   g_colourDRLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(wxS("DefaultInActiveDRLineColour"),
                   g_colourInActiveDRLineColour.GetAsString(wxC2S_CSS_SYNTAX));
      ...
      pConf->Write(wxS("DefaultODPointArrivalCircle_Radius"),
                   g_dODPointArrivalCircleRadius);
      pConf->Write(wxS("DefaultODPointIcon"), g_sODPointIconName);
      pConf->Write(wxS("DefaultODPointShowRangeRings"),
                   g_bODPointShowRangeRings);
      ...
      pConf->Write(wxS("ODPointRangeRingsStepUnits"),
                   g_iODPointRangeRingsStepUnits);
      pConf->Write(
          wxS("ODPointRangeRingsColour"),
          g_colourODPointRangeRingsColour.GetAsString(wxC2S_CSS_SYNTAX));
      long l_longBoundaryPointFillTransparency =
          g_uiBoundaryPointFillTransparency;
      pConf->Write(wxS("DefaultBoundaryPointFillTransparency"),
                   l_longBoundaryPointFillTransparency);
      pConf->Write(wxS("DefaultBoundaryPointRangeRingLineWidth"),
                   g_iBoundaryPointRangeRingLineWidth);
      pConf->Write(wxS("DefaultBoundaryPointRangeRingLineStyle"),
                   (int)g_iBoundaryPointRangeRingLineStyle);
      pConf->Write(wxS("DefaultInclusionBoundaryPointSize"),
                   g_iInclusionBoundaryPointSize);
      pConf->Write(wxS("ShowMag"), g_bShowMag);
      pConf->Write(wxS("AllowLeftDrag"), g_bAllowLeftDrag);
      pConf->Write(wxS("UserMagVariation"),
      ...
      pConf->Write(wxS("RemeberPropertiesDialogPosition"),
                   g_bRememberPropertyDialogPosition);
      pConf->Write(wxS("InitialEdgePanSensitivity"),
                   g_InitialEdgePanSensitivity);
      ...
      pConf->Write(wxS("DefaultRestoreLayerVisability"),
                   g_bRestoreLayerVisability);
      pConf->Write(wxS("DefaultTextPointShowName"), g_bTextPointShowName);
      pConf->Write(wxS("DefaultTextPointIcon"), g_sTextPointIconName);
      pConf->Write(wxS("DefaultTextColour"),
                   g_colourDefaultTextColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(
          wxS("DefaultTextBackgroundColour"),
          g_colourDefaultTextBackgroundColour.GetAsString(wxC2S_CSS_SYNTAX));
      pConf->Write(wxS("DefaultTextBackgroundTransparency"),
                   g_iTextBackgroundTransparency);
      ...
      pConf->Write(wxS("DefaultTextBottomNameExtraOffsetY"),
                   g_iTextBottomNameExtraOffsetY);
      ...
      pConf->Write(wxS("DefaultTextPointPointSize"),
                   g_DisplayTextFont.GetPointSize());
      pConf->Write(wxS("DefaultTextPointFontFamily"),
                   (int)g_DisplayTextFont.GetFamily());
      pConf->Write(wxS("DefaultTextPointFontStyle"),
                   (int)g_DisplayTextFont.GetStyle());
      pConf->Write(wxS("DefaultTextPointFontWeight"),
                   (int)g_DisplayTextFont.GetWeight());
      pConf->Write(wxS("DefaultTextPointFontUnderline"),
                   g_DisplayTextFont.GetUnderlined());
#if wxCHECK_VERSION(3, 0, 0)
      pConf->Write(wxS("DefaultTextPointFontStrikethrough"),
                   g_DisplayTextFont.GetStrikethrough());
#endif
      pConf->Write(wxS("DefaultTextPointFaceName"),
                   g_DisplayTextFont.GetFaceName());
      pConf->Write(wxS("DefaultTextPointFontEncoding"),
                   (int)g_DisplayTextFont.GetEncoding());
      pConf->Write(wxS("DefaultTextPointDisplayTextWhen"),
                   g_iTextPointDisplayTextWhen);
      ...
      if (g_bRememberPropertyDialogPosition) {
        pConf->Write(wxS("DefaultBoundaryPropertyDialogPositionX"),
                     g_iDefaultBoundaryPropertyDialogPostionX);
        pConf->Write(wxS("DefaultBoundaryPropertyDialogPositionY"),
                     g_iDefaultBoundaryPropertyDialogPostionY);
        pConf->Write(wxS("DefaultDRPropertyDialogPositionX"),
                     g_iDefaultDRPropertyDialogPostionX);
        pConf->Write(wxS("DefaultDRPropertyDialogPositionY"),
                     g_iDefaultDRPropertyDialogPostionY);
        pConf->Write(wxS("DefaultEBLPropertyDialogPositionX"),
                     g_iDefaultEBLPropertyDialogPostionX);
        pConf->Write(wxS("DefaultEBLPropertyDialogPositionY"),
                     g_iDefaultEBLPropertyDialogPostionY);
        pConf->Write(wxS("DefaultGZPropertyDialogPositionX"),
                     g_iDefaultGZPropertyDialogPostionX);
        pConf->Write(wxS("DefaultGZPropertyDialogPositionY"),
                     g_iDefaultGZPropertyDialogPostionY);
        pConf->Write(wxS("DefaultPathPropertyDialogPositionX"),
                     g_iDefaultPathPropertyDialogPostionX);
        pConf->Write(wxS("DefaultPathPropertyDialogPositionY"),
                     g_iDefaultPathPropertyDialogPostionY);
        pConf->Write(wxS("DefaultPointPropertyDialogPositionX"),
                     g_iDefaultPointPropertyDialogPostionX);
        pConf->Write(wxS("DefaultPointPropertyDialogPositionY"),
                     g_iDefaultPointPropertyDialogPostionY);
        pConf->Write(wxS("DefaultPILPropertyDialogPositionX"),
                     g_iDefaultPILPropertyDialogPostionX);
        pConf->Write(wxS("DefaultPILPropertyDialogPositionY"),
                     g_iDefaultPILPropertyDialogPostionY);
        pConf->Write(wxS("DefaultPILLinePropertyDialogPositionX"),
                     g_iDefaultPILLinePropertyDialogPostionX);
        pConf->Write(wxS("DefaultPILLinePropertyDialogPositionY"),
                     g_iDefaultPILLinePropertyDialogPostionY);
        pConf->Write(wxS("DefaultPathAndPointManagerDialogPositionX"),
                     g_iDefaultPathAnPointManagerDialogPostionX);
        pConf->Write(wxS("DefaultPathAndPointManagerDialogPositionY"),
                     g_iDefaultPathAnPointManagerDialogPostionY);
      } else {
...
void ocpn_draw_pi::LoadConfig() {
  ...
  if (pConf) {
    ...
    pConf->Read(wxS("DefaultBoundaryPointShowName"), &g_bBoundaryPointShowName,
                false);
    pConf->Read(wxS("DefaultActivePathLineColour"), &l_wxsColour, wxS("RED"));
    g_colourActivePathLineColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultInActivePathLineColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    g_colourInActivePathLineColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultActiveBoundaryLineColour"), &l_wxsColour,
                wxS("RED"));
    g_colourActiveBoundaryLineColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultInActiveBoundaryLineColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    g_colourInActiveBoundaryLineColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultActiveBoundaryFillColour"), &l_wxsColour,
                wxS("RED"));
    g_colourActiveBoundaryFillColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultInActiveBoundaryFillColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    g_colourInActiveBoundaryFillColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultInActiveBoundaryFillColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    int l_BoundaryType;
    pConf->Read(wxS("DefaultBoundaryType"), &l_BoundaryType,
    ...
    pConf->Read(wxS("DefaultBoundaryODPointsVisible"),
                &g_bBoundaryODPointsVisible, 1);
    pConf->Read(wxS("DefaultEBLLineColour"), &l_wxsColour, wxS("RED"));
    g_colourEBLLineColour.Set(l_wxsColour);
    long l_longFillTransparency;
    pConf->Read(wxS("DefaultBoundaryFillTransparency"), &l_longFillTransparency,
                175);
    g_uiFillTransparency = l_longFillTransparency;
    pConf->Read(wxS("DefaultBoundaryPointRangeRingLineWidth"),
                &g_iBoundaryPointRangeRingLineWidth, 2);
    pConf->Read(wxS("DefaultBoundaryPointRangeRingLineStyle"), &l_style,
                wxPENSTYLE_SOLID);
    g_iBoundaryPointRangeRingLineStyle = (wxPenStyle)l_style;
    pConf->Read(wxS("DefaultInclusionBoundarySize"), &g_iInclusionBoundarySize,
                15);
    ...
    pConf->Read(wxS("DefaultGZSecondIcon"), &g_sGZSecondIconName,
                wxS("Circle"));
    pConf->Read(wxS("DefaultActiveGZLineColour"), &l_wxsColour, wxS("RED"));
    g_colourActiveGZLineColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultInActiveGZLineColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    ...
    pConf->Read(wxS("DefaultInActiveGZFillColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    ...
    pConf->Read(wxS("DefaultGZFillTransparency"), &l_longGZFillTransparency,
                175);
    g_uiGZFillTransparency = l_longGZFillTransparency;
    pConf->Read(wxS("DefaultGZRotateWithBoat"), &g_bGZRotateWithBoat, false);
    pConf->Read(wxS("DefaultGZMaintainWith"), &g_iGZMaintainWith,
                ID_MAINTAIN_WITH_HEADING);
    ...
    pConf->Read(wxS("DefaultEBLStartIcon"), &g_sEBLStartIconName,
                wxS("Circle"));
    ...
    pConf->Read(wxS("DefaultEBLMaintainWith"), &g_iEBLMaintainWith,
                ID_MAINTAIN_WITH_HEADING);

    pConf->Read(wxS("DefaultPILEndIcon"), &g_sPILEndIconName, wxS("Circle"));
    pConf->Read(wxS("DefaultPILStartIcon"), &g_sPILStartIconName,
                wxS("Circle"));
    pConf->Read(wxS("DefaultPILActiveCentreLineColour"), &l_wxsColour,
                wxS("RED"));
    g_colourPILActiveCentreLineColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultPILInActiveCentreLineColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    g_colourPILInActiveCentreLineColour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultPILActiveOffsetLine1Colour"), &l_wxsColour,
                wxS("Red"));
    g_colourPILActiveOffsetLine1Colour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultPILInActiveOffsetLine1Colour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    g_colourPILInActiveOffsetLine1Colour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultPILActiveOffsetLine2Colour"), &l_wxsColour,
                wxS("Red"));
    g_colourPILActiveOffsetLine2Colour.Set(l_wxsColour);
    pConf->Read(wxS("DefaultPILInActiveOffsetLine2Colour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    ...
    pConf->Read(wxS("DefaultShowDRPointRangeRings"), &g_bDRPointShowRangeRings,
                false);
    pConf->Read(wxS("DefaultDRPointRangeRingsNumber"),
                &g_iDRPointRangeRingsNumber, 0);
    pConf->Read(wxS("DefaultDRPointRangeRingsStep"), &val, wxS("1.0"));
    g_fDRPointRangeRingsStep = atof(val.mb_str());
    pConf->Read(wxS("DefaultDRPointRangeRingsStepUnits"),
                &g_iDRPointRangeRingsStepUnits, 0);
    wxString l_wxsDRPointRangeRingsColour;
    g_colourDRPointRangeRingsColour = wxColour(*wxRED);
    pConf->Read(wxS("DefaultDRPointRangeRingsColour"),
                &l_wxsDRPointRangeRingsColour, wxS("RED"));
    g_colourDRPointRangeRingsColour.Set(l_wxsDRPointRangeRingsColour);
    pConf->Read(wxS("DefaultDRPointRangeRingLineWidth"),
                &g_iDRPointRangeRingLineWidth, 2);
    pConf->Read(wxS("DefaultDRPointRangeRingLineStyle"), &l_style,
                wxPENSTYLE_SOLID);
    ...
    pConf->Read(wxS("DefaultInActiveDRLineColour"), &l_wxsColour,
                wxS("LIGHT GREY"));
    ...
    pConf->Read(wxS("DefaultODPointArrivalCircle_Radius"),
                &g_dODPointArrivalCircleRadius, 0.5);
    pConf->Read(wxS("DefaultODPointIcon"), &g_sODPointIconName,
                wxS("triangle"));
    pConf->Read(wxS("DefaultODPointShowRangeRings"), &g_bODPointShowRangeRings,
                false);
    ...
    pConf->Read(wxS("ODPointRangeRingsStepUnits"),
                &g_iODPointRangeRingsStepUnits, 0);
    wxString l_wxsODPointRangeRingsColour;
    g_colourODPointRangeRingsColour = wxColour(*wxRED);
    pConf->Read(wxS("ODPointRangeRingsColour"), &l_wxsODPointRangeRingsColour,
                wxS("RED"));
    g_colourODPointRangeRingsColour.Set(l_wxsODPointRangeRingsColour);
    long l_longBoundaryPointFillTransparency;
    pConf->Read(wxS("DefaultBoundaryPointFillTransparency"),
                &l_longBoundaryPointFillTransparency, 175);
    g_uiBoundaryPointFillTransparency = l_longBoundaryPointFillTransparency;
    pConf->Read(wxS("DefaultInclusionBoundaryPointSize"),
                &g_iInclusionBoundaryPointSize, 15);
    int l_BoundaryPointType;
    pConf->Read(wxS("DefaultBoundaryPointType"), &l_BoundaryPointType,
                ID_BOUNDARY_EXCLUSION);
    ...
    pConf->Read(wxS("RemeberPropertiesDialogPosition"),
                &g_bRememberPropertyDialogPosition, false);

    pConf->Read(wxS("InitialEdgePanSensitivity"), &g_InitialEdgePanSensitivity,
                2);
    ...
    pConf->Read(wxS("DefaultRestoreLayerVisability"),
                &g_bRestoreLayerVisability, false);

    pConf->Read(wxS("DefaultTextPointShowName"), &g_bTextPointShowName, false);
    pConf->Read(wxS("DefaultTextPointIcon"), &g_sTextPointIconName,
                wxS("Circle"));
    wxString l_wxsDefautlTextColour;
    pConf->Read(wxS("DefaultTextColour"), &l_wxsDefautlTextColour,
                wxS("BLACK"));
    g_colourDefaultTextColour.Set(l_wxsDefautlTextColour);
    wxString l_wxsDefautlTextBackgroundColour;
    pConf->Read(wxS("DefaultTextBackgroundColour"),
                &l_wxsDefautlTextBackgroundColour, wxS("YELLOW"));
    g_colourDefaultTextBackgroundColour.Set(l_wxsDefautlTextBackgroundColour);
    pConf->Read(wxS("DefaultTextBackgroundTransparency"),
                &g_iTextBackgroundTransparency, 100);
    ...
    pConf->Read(wxS("DefaultTextBottomNameExtraOffsetY"),
                &g_iTextBottomNameExtraOffsetY, 10);
    ...
    pConf->Read(wxS("DefaultTextPointPointSize"), &l_fontInfo,
                (int)l_pDisplayTextFont->GetPointSize());
    g_DisplayTextFont.SetPointSize(l_fontInfo);
    pConf->Read(wxS("DefaultTextPointFontFamily"), &l_fontInfo,
                (int)l_pDisplayTextFont->GetFamily());
    g_DisplayTextFont.SetFamily((wxFontFamily)l_fontInfo);
    pConf->Read(wxS("DefaultTextPointFontStyle"), &l_fontInfo,
                (int)l_pDisplayTextFont->GetStyle());
    g_DisplayTextFont.SetStyle((wxFontStyle)l_fontInfo);
    pConf->Read(wxS("DefaultTextPointFontWeight"), &l_fontInfo,
                (int)l_pDisplayTextFont->GetWeight());
    ...
    pConf->Read(wxS("DefaultTextPointFaceName"), &l_wxsFaceName,
                l_pDisplayTextFont->GetFaceName());
    g_DisplayTextFont.SetFaceName(l_wxsFaceName);
    pConf->Read(wxS("DefaultTextPointFontEncoding"), &l_fontInfo,
                (int)l_pDisplayTextFont->GetEncoding());
    g_DisplayTextFont.SetEncoding((wxFontEncoding)l_fontInfo);
    pConf->Read(wxS("DefaultTextPointDisplayTextWhen"),
                &g_iTextPointDisplayTextWhen,
                ID_TEXTPOINT_DISPLAY_TEXT_SHOW_ALWAYS);
    ...
    pConf->Read(wxS("DefaultBoundaryPropertyDialogPositionX"),
                &g_iDefaultBoundaryPropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultBoundaryPropertyDialogPositionY"),
                &g_iDefaultBoundaryPropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultDRPropertyDialogPositionX"),
                &g_iDefaultDRPropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultDRPropertyDialogPositionY"),
                &g_iDefaultDRPropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultEBLPropertyDialogPositionX"),
                &g_iDefaultEBLPropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultEBLPropertyDialogPositionY"),
                &g_iDefaultEBLPropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultGZPropertyDialogPositionX"),
                &g_iDefaultGZPropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultGZPropertyDialogPositionY"),
                &g_iDefaultGZPropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultPathPropertyDialogPositionX"),
                &g_iDefaultPathPropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultPathPropertyDialogPositionY"),
                &g_iDefaultPathPropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultPointPropertyDialogPositionX"),
                &g_iDefaultPointPropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultPointPropertyDialogPositionY"),
                &g_iDefaultPointPropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultPILPropertyDialogPositionX"),
                &g_iDefaultPILPropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultPILPropertyDialogPositionY"),
                &g_iDefaultPILPropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultPILLinePropertyDialogPositionX"),
                &g_iDefaultPILLinePropertyDialogPostionX, -1);
    pConf->Read(wxS("DefaultPILLinePropertyDialogPositionY"),
                &g_iDefaultPILLinePropertyDialogPostionY, -1);
    pConf->Read(wxS("DefaultPathAndPointManagerDialogPositionX"),
                &g_iDefaultPathAnPointManagerDialogPostionX, -1);
    pConf->Read(wxS("DefaultPathAndPointManagerDialogPositionY"),
...
void ocpn_draw_pi::SetPluginMessage(wxString& message_id,
...
bool ocpn_draw_pi::KeyboardEventHook(wxKeyEvent& event) {
  ...
  if (event.GetKeyCode() < 128)  // ascii
  {
    ...
    if ((bKey_Boundary_Pressed || bKey_Point_Pressed ||
         bKey_TextPoint_Pressed || bKey_EBL_Pressed || bKey_DR_Pressed ||
         bKey_GZ_Pressed || bKey_PIL_Pressed) &&
        key_char != WXK_ESCAPE)
      return true;
...
bool ocpn_draw_pi::MouseEventHook(wxMouseEvent& event) {
  ...
  if (nBoundary_State == 1 || nPoint_State >= 1 || nPath_State == 1 ||
      nTextPoint_State == 1 || nEBL_State > 0 || nGZ_State > 0 ||
      nPIL_State > 0 || m_bPathEditing || m_bODPointEditing ||
      m_bTextPointEditing || m_bEBLMoveOrigin) {
    CheckMUIEdgePan_PlugIn(g_cursor_x, g_cursor_y, event.Dragging(),
                           g_InitialEdgePanSensitivity, 2,
                           m_mouse_canvas_index);
    bRefresh = TRUE;
  }
  ...
  if (nBoundary_State >= 2) {
    ...
    bool l_bret =
        CheckMUIEdgePan_PlugIn(g_cursor_x, g_cursor_y, event.Dragging(),
                               g_EdgePanSensitivity, 2, m_drawing_canvas_index);
    bRefresh = TRUE;
    //        if(l_bret)
    //            return l_bret;
  }
  ...
  if (event.LeftDClick()) {
    ...
    if (m_pSelectedPath && m_seltype == SELTYPE_PATHSEGMENT) {
      if (NULL == g_pPathAndPointManagerDialog)  // There is one global instance
                                                 // of the Dialog
        g_pPathAndPointManagerDialog =
            new PathAndPointManagerDialogImpl(m_parent_window);
      ...
      g_PILIndexLinePropDialog->UpdateProperties((PIL*)m_pSelectedPath,
                                                 m_iPILId);
  ...
  if (event.LeftDown()) {
    if (m_iCallerId == m_draw_button_id) {
      ...
      if (nBoundary_State > 0) {
        ...
        bret = CreatePILLeftClick(event);
               ...
               (m_iEditMode == ID_PATH_MENU_MOVE_PATH ||
                m_iEditMode == ID_PATH_MENU_MOVE_PATH_SEGMENT ||
      ...
      //                    m_pSelectedDR = NULL;
      //                    m_pSelectedGZ = NULL;
      //                    if(m_pSelectedPath->m_sTypeString ==
      //                    wxT("Boundary"))
      //                        m_pSelectedBoundary = (Boundary
      //                        *)m_pSelectedPath;
      //                    else if(m_pSelectedPath->m_sTypeString ==
      //                    wxT("EBL"))
      //                        m_pSelectedEBL = (EBL *)m_pSelectedPath;
      //                    else if(m_pSelectedPath->m_sTypeString == wxT("DR"))
      //                        m_pSelectedDR = (DR *)m_pSelectedPath;
      //                    else if(m_pSelectedPath->m_sTypeString == wxT("Guard
      //                    Zone"))
        ...
        if (m_pSelectedPath && !m_pSelectedPath->m_bIsInLayer) {
          ...
          if (m_pSelectedPath->m_sTypeString == wxT("Boundary")) {
            ...
            if (event.ControlDown()) {
              std::list<Boundary*>::iterator it = m_pBoundaryList.begin();
              while (it != m_pBoundaryList.end()) {
                if (*it == m_pSelectedBoundary) break;
                ++it;
              }
  ...
  if (event.LeftUp()) {
    if (m_iCallerId == m_draw_button_id &&
        (nBoundary_State > 0 || nPoint_State > 0 || nTextPoint_State > 0 ||
         nEBL_State > 0 || nDR_State > 0 || nGZ_State > 0 || nPIL_State > 0)) {
      bret = true;
    } else {
      if (!m_bPathEditing && !m_bEBLMoveOrigin &&
          !m_bODPointEditing) {  // Handle left up moving origin when doing
                                 // double left click on OD object
        FindSelectedObject();
      ...
      if (m_bEBLMoveOrigin) {
        ...
        if (l_bUpdateSelect) {
          ...
          if (m_pSelectedPIL) m_pSelectedPIL->UpdatePIL();
        }
        ...
        g_pODConfig->m_bSkipChangeSetUpdate = false;
        if (m_pSelectedPath->m_sTypeString == wxT("EBL") ||
            m_pSelectedPath->m_sTypeString == wxT("PIL")) {
          ...
          if (m_pSelectedEBL) m_pSelectedEBL->m_bEndPointMoving = false;
          if (m_pSelectedPIL) m_pSelectedPIL->m_bEndPointMoving = false;
        } else
          g_pODConfig->UpdatePath(m_pSelectedPath);
        ...
        if (m_pSelectedPath->m_pODPointList) {
          for (unsigned int ip = 0;
               ip < m_pSelectedPath->m_pODPointList->GetCount(); ip++) {
        ...
        g_pODSelect->AddSelectableODPoint(m_cursor_lat, m_cursor_lon,
                                          m_pFoundODPoint);
        bool prev_bskip = g_pODConfig->m_bSkipChangeSetUpdate;
        g_pODConfig->m_bSkipChangeSetUpdate = false;
        ...
        // This is to handle the double click to bring up the dialog box so that
        // the screen does not jump on the extra clicks.
        bret = TRUE;
      }
  ...
  if (event.Dragging()) {
    if (event.LeftIsDown()) {
      ...
      if (nBoundary_State > 0 || nPoint_State > 0)
        bret = true;
      else if (m_pFoundODPoint && (m_iEditMode == ID_PATH_MENU_MOVE_POINT ||
                                   m_iEditMode == ID_ODPOINT_MENU_MOVE)) {
        if (m_drawing_canvas_index == m_mouse_canvas_index) {
          if (m_bPathEditing) {
            ...
            if ((NULL != g_pODPathPropDialog) &&
                (g_pODPathPropDialog->IsShown()) &&
                m_pSelectedPath == g_pODPathPropDialog->GetPath())
              g_pODPathPropDialog->UpdateProperties(m_pSelectedPath);
            if (g_pODPointPropDialog && g_pODPointPropDialog->IsShown() &&
                m_pFoundODPoint == g_pODPointPropDialog->GetODPoint())
              g_pODPointPropDialog->UpdateProperties(TRUE);
        ...
        if (m_iEditMode == ID_PATH_MENU_MOVE_PATH)
          ...
          m_pSelectedPath->MoveSegment(l_move_lat, l_move_lon, m_pFoundODPoint,
                                       m_pFoundODPointSecond);
        m_PathMove_cursor_start_lat = m_cursor_lat;
        m_PathMove_cursor_start_lon = m_cursor_lon;
        bRefresh = TRUE;
        bret = FALSE;
  ...
  if (event.RightDown()) {
    if (m_bODPointEditing) {
      ...
      bRefresh = TRUE;
      bret = TRUE;
    } else if (nBoundary_State == 1 || nPoint_State == 1 ||
               nTextPoint_State == 1 || nEBL_State == 1 || nDR_State == 1 ||
               nGZ_State == 1 || nPIL_State == 1) {
      m_Mode++;
      if (m_Mode >= ID_MODE_BOUNDARY) SetToolbarTool();
      g_pODToolbar->SetToolbarTool(m_Mode);
      bret = TRUE;
      ...
      bRefresh = TRUE;
      bret = true;
    } else if (nBoundary_State == 0 && nPoint_State == 0 &&
               nTextPoint_State == 0 && nEBL_State == 0 && nDR_State == 0 &&
               nGZ_State == 0 && nPIL_State == 0) {
      FindSelectedObject();
  ...
  if (!b_start_rollover && !m_bPathEditing && !bRefresh) {
    ODSelectableItemList SelList = g_pODSelect->FindSelectionList(
        m_cursor_lat, m_cursor_lon, SELTYPE_PATHSEGMENT);
...
void ocpn_draw_pi::FindSelectedObject() {
  ...
  if (pFindPP) {
    ...
    ODSelectableItemList SelList =
        g_pODSelect->FindSelectionList(slat, slon, SELTYPE_ODPOINT);
    wxODSelectableItemListNode* node = SelList.GetFirst();
    while (node) {
      ODSelectItem* pFindSel = node->GetData();

      ODPoint* pop = (ODPoint*)pFindSel->m_pData1;  // candidate
      if ((pop->m_sTypeString == wxT("EBL Point") &&
           pop->m_ODPointName == _("Boat")) ||
          !pop->m_bIsVisible) {
        node = node->GetNext();
        continue;
      }
      ...
      // Give preference to any visible active path, otherwise select the first
      // visible path in the array for this point
      if (ppath_array) {
        for (unsigned int ip = 0; ip < ppath_array->GetCount(); ip++) {
          ODPath* pp = (ODPath*)ppath_array->Item(ip);
    ...
    if (l_pSelectedPath) {
      if (l_pSelectedPath->IsVisible()) m_seltype |= SELTYPE_ODPOINT;
  ...
  if (pFindPathSeg) {  // there is at least one select item
    ODSelectableItemList SelList =
        g_pODSelect->FindSelectionList(slat, slon, SELTYPE_PATHSEGMENT);
  ...
  if (pFindPILIndex) {
    ...
    m_iPILId = pFindPILIndex
                   ->GetUserData();  // get Id of particular PIL being selected
  }
}
...
wxString ocpn_draw_pi::FormatDistanceAdaptive(double distance) {
  ...
  if (usrDistance < 0.1 &&
      (sUnit->IsSameAs(wxS("km")) || sUnit->IsSameAs(wxS("mi")) ||
       sUnit->IsSameAs(wxS("NMi")))) {
    if (sUnit->IsSameAs(wxS("mi")))
      sUnit->assign(wxS("ft"));
    else
      sUnit->assign(wxS("M"));
...
void ocpn_draw_pi::latlong_to_chartpix(double lat, double lon, double& pixx,
                                       double& pixy) {
  m_lat = lat;
  m_lon = lon;
  m_pixx = pixx;
...
bool ocpn_draw_pi::RenderOverlayMultiCanvas(wxDC& dc, PlugIn_ViewPort* vp,
                                            int canvas_index) {
  g_bOpenGL = false;
...
bool ocpn_draw_pi::RenderGLOverlayMultiCanvas(wxGLContext* pcontext,
                                              PlugIn_ViewPort* vp,
                                              int canvas_index, int priority) {
...
void ocpn_draw_pi::RenderPathLegs(piDC& dc) {
  ...
  if (nBoundary_State >= 2) {
    ...
    DistanceBearingMercator_Plugin(m_cursor_lat, m_cursor_lon, m_prev_rlat,
                                   m_prev_rlon, &rhumbBearing, &rhumbDist);
    Geodesic::GreatCircleDistBear(m_prev_rlon, m_prev_rlat, m_cursor_lon,
    ...
    if (boundary->m_NextLegGreatCircle) {
      for (int i = 1; i <= milesDiff; i++) {
        ...
        double pLat, pLon;
        Geodesic::GreatCircleTravel(m_prev_rlon, m_prev_rlat, gcDist * p, brg,
    ...
    if (m_bEBLMoveOrigin) {
      ODPoint* tp =
          (ODPoint*)m_pSelectedEBL->m_pODPointList->GetLast()->GetData();
    ...
    if (info.length() > 0) RenderExtraPathLegInfo(dc, l_cursorPoint, info);
    delete ebl;
    ...
    if (!(nGZ_State & 1)) {
      ...
      GetCanvasPixLL(&g_VP, &l_l1p1,
                     m_pMouseGZ->m_pODPointList->GetFirst()->GetData()->m_lat,
                     m_pMouseGZ->m_pODPointList->GetFirst()->GetData()->m_lon);
      // get x, y of second point on first line
      PositionBearingDistanceMercator_Plugin(g_pfFix.Lat, g_pfFix.Lon,
                                             m_pMouseGZ->m_dFirstLineDirection,
                                             dist, &l_dLat, &l_dLon);
      ...
      PositionBearingDistanceMercator_Plugin(g_pfFix.Lat, g_pfFix.Lon, brg,
                                             m_pMouseGZ->m_dFirstDistance,
                                             &l_dLat, &l_dLon);
      GetCanvasPixLL(&g_VP, &l_l2p1, l_dLat, l_dLon);

      if (g_iGZLineType == ID_LINE_TYPE_ARC)
        gz->DrawArcSegment(dc, &boatpoint, &l_l1p1, &l_l1p2, &l_l2p2, &l_l2p1,
                           m_VP, false);
      else {
        gz->RenderSegment(dc, l_l1p1.x, l_l1p1.y, l_l1p2.x, l_l1p2.y, m_VP,
                          false);
        gz->RenderSegment(dc, l_l1p2.x, l_l1p2.y, l_l2p2.x, l_l2p2.y, m_VP,
                          false);
        gz->RenderSegment(dc, l_l2p2.x, l_l2p2.y, l_l2p1.x, l_l2p1.y, m_VP,
                          false);
        gz->RenderSegment(dc, l_l2p1.x, l_l2p1.y, l_l1p1.x, l_l1p1.y, m_VP,
                          false);
      }
...
wxString ocpn_draw_pi::CreateExtraPathLegInfo(piDC& dc, ODPath* path,
  ...
  if (path->m_sTypeString == wxT("EBL")) {
    ...
    if (g_bShowMag)
      pathInfo << wxString::Format(
          wxString("From: %03d \u00B0(M), To: %03d \u00B0(M)\n Dist:",
                   wxConvUTF8),
          EBLbrgFrom, EBLbrgTo);
    else
      pathInfo << wxString::Format(
          wxString("From: %03d \u00B0, To: %03d \u00B0\n Dist:", wxConvUTF8),
          EBLbrgFrom, EBLbrgTo);
  } else {
    if (g_bShowMag)
      pathInfo << wxString::Format(wxString("%03d\u00B0(M)  ", wxConvUTF8),
                                   (int)GetTrueOrMag(brg));
    else
      pathInfo << wxString::Format(wxString("%03d \u00B0  ", wxConvUTF8),
                                   (int)GetTrueOrMag(brg));
  }
...
void ocpn_draw_pi::RenderExtraPathLegInfo(piDC& dc, wxPoint ref_point,
                                          wxString s) {
...
void ocpn_draw_pi::FinishBoundary(void) {
  ...
  if (m_pMouseBoundary && m_pMouseBoundary->GetnPoints() > 1 &&
      m_pMouseBoundary->m_pLastAddedPoint !=
          m_pMouseBoundary->m_pFirstAddedPoint) {
    g_pODSelect->AddSelectablePathSegment(
        m_prev_rlat, m_prev_rlon, m_dStartLat, m_dStartLon,
        m_pMouseBoundary->m_pLastAddedPoint,
        m_pMouseBoundary->m_pFirstAddedPoint, m_pMouseBoundary);
  ...
  while (pnode) {
    ...
    if (pPathDraw) {
      ...
      if (pPathDraw == m_pSelectedEBL && m_bODPointEditing &&
        ...
        wxPoint destPoint;
        ODPoint* pStartPoint =
            m_pSelectedEBL->m_pODPointList->GetFirst()->GetData();
        ODPoint* pEndPoint =
            m_pSelectedEBL->m_pODPointList->GetLast()->GetData();
        DistanceBearingMercator_Plugin(pEndPoint->m_lat, pEndPoint->m_lon,
                                       pStartPoint->m_lat, pStartPoint->m_lon,
                                       &brg, &dist);
        if (m_pFoundODPoint == pEndPoint)
          GetCanvasPixLL(&m_VP, &destPoint, pEndPoint->m_lat, pEndPoint->m_lon);
        else
          GetCanvasPixLL(&m_VP, &destPoint, pStartPoint->m_lat,
                         pStartPoint->m_lon);
        wxString info =
        ...
        if (m_iEditMode == ID_PIL_MENU_MOVE_INDEX_LINE) {
          std::list<PILLINE>::iterator it =
              m_pSelectedPIL->m_PilLineList.begin();
          ...
          info = CreateExtraPathLegInfo(
              dc, m_pSelectedPIL, m_pSelectedPIL->m_dEBLAngle,
...
bool ocpn_draw_pi::CreatePointLeftClick(wxMouseEvent& event) {
  ...
  BoundaryPoint* pNearbyPoint = (BoundaryPoint*)g_pODPointMan->GetNearbyODPoint(
  ...
  if (pNearbyPoint && (pNearbyPoint != (BoundaryPoint*)m_prev_pMousePoint) &&
    ...
    int dlg_return;
#ifndef __WXOSX__
    dlg_return = OCPNMessageBox_PlugIn(
        m_parent_window, _("Use nearby Point?"), _("OCPN Draw Point Create"),
    ...
    if (dlg_return == wxID_YES) {
      ...
      // check all other boundaries and paths to see if this point appears in
      // any other path If it appears in NO other path, then it should e
      // considered an isolated mark
      if (!g_pPathMan->FindPathContainingODPoint(pMousePoint))
        pMousePoint->m_bKeepXPath = true;
    }
  }

  if (NULL == pMousePoint) {  // need a new point
    //        pMousePoint = new ODPoint( rlat, rlon, g_sODPointIconName,
    //        wxS(""), wxT("") );
    pMousePoint =
        new BoundaryPoint(rlat, rlon, g_sODPointIconName, wxS(""), wxT(""));
...
bool ocpn_draw_pi::CreateTextPointLeftClick(wxMouseEvent& event) {
  ...
  TextPoint* pNearbyPoint = (TextPoint*)g_pODPointMan->GetNearbyODPoint(
      rlat, rlon, nearby_radius_meters);
  ...
  if (NULL == pMousePoint) {  // need a new point
    pMousePoint =
        new TextPoint(rlat, rlon, g_sTextPointIconName, wxS(""), wxT(""));
...
#ifndef __WXOSX__
    dlg_return =
        OCPNMessageBox_PlugIn(m_parent_window, _("Use nearby OD Point?"),
  ...
  if (m_pMouseBoundary) {
    if (nBoundary_State == 1) {
      ...
      if (m_pMouseBoundary->m_NextLegGreatCircle) {
        ...
        DistanceBearingMercator_Plugin(rlat, rlon, m_prev_rlat, m_prev_rlon,
        ...
        int segmentCount =
            (3.0 + (rhumbDist - gcDistNM)) / pow(rhumbDist - gcDistNM - 1, 0.5);

        wxString msg;
        msg << _("For this leg the Great Circle boundary is ")
            << FormatDistanceAdaptive(rhumbDist - gcDistNM)
            << _(" shorter than rhumbline.\n\n")
            << _("Would you like include the Great Circle boundary points for "
                 "this leg?");

        m_disable_edge_pan = true;  // This helps on OS X if MessageBox does not
                                    // fully capture mouse

        int answer = OCPNMessageBox_PlugIn(m_parent_window, msg,
                                           _("OCPN Draw Boundary Create"),
        ...
        if (answer == wxID_YES) {
          ...
          for (int i = 1; i <= segmentCount; i++) {
            ...
            if (i < segmentCount) {
              gcPoint = new BoundaryPoint(gcCoord.y, gcCoord.x, wxS("xmblue"),
                                          wxS(""), wxT(""));
            ...
            g_pODSelect->AddSelectablePathSegment(
                ...
                gcPoint->m_lon, prevGcPoint, gcPoint, m_pMouseBoundary);
            prevGcPoint = gcPoint;
          }
          ...
          m_pMouseBoundary->AddPoint(pMousePoint);
          g_pODSelect->AddSelectablePathSegment(m_prev_rlat, m_prev_rlon, rlat,
                                                rlon, m_prev_pMousePoint,
                                                pMousePoint, m_pMouseBoundary);
          // TODO fix up undo
      ...
      pMousePoint->m_bExclusionBoundaryPoint =
          m_pMouseBoundary->m_bExclusionBoundary;
      pMousePoint->m_bInclusionBoundaryPoint =
          m_pMouseBoundary->m_bInclusionBoundary;
    }
  }
...
bool ocpn_draw_pi::CreateEBLLeftClick(wxMouseEvent& event) {
  ...
  m_pMouseEBL->m_PathNameString << _("EBL") << _T(" ")
                                << g_pEBLList->GetCount();
  m_dStartLat = g_pfFix.Lat;
  m_dStartLon = g_pfFix.Lon;

  ODPoint* beginPoint = new ODPoint(g_pfFix.Lat, g_pfFix.Lon,
                                    g_sEBLStartIconName, _("Boat"), wxT(""));
  ...
  DistanceBearingMercator_Plugin(rlat, rlon, m_dStartLat, m_dStartLon,
                                 &m_pMouseEBL->m_dEBLAngle,
                                 &m_pMouseEBL->m_dLength);

  if (m_pMouseEBL->m_bRotateWithBoat) {
    switch (m_pMouseEBL->m_iMaintainWith) {
      case ID_MAINTAIN_WITH_HEADING:
        if (!wxIsNaN(g_pfFix.Hdt)) m_pMouseEBL->m_dEBLAngle -= g_pfFix.Hdt;
        break;
      case ID_MAINTAIN_WITH_COG:
        if (!wxIsNaN(g_pfFix.Cog)) m_pMouseEBL->m_dEBLAngle -= g_pfFix.Cog;
        break;
    }
  }

  if (m_pMouseEBL->m_iPersistenceType == ID_PERSISTENT ||
      m_pMouseEBL->m_iPersistenceType == ID_PERSISTENT_CRASH)
    g_pODConfig->AddNewPath(m_pMouseEBL, -1);  // don't save over restart
  g_pODSelect->AddSelectableODPoint(rlat, rlon, pMousePoint);
  g_pODSelect->AddSelectablePathSegment(g_pfFix.Lat, g_pfFix.Lon, rlat, rlon,
                                        beginPoint, pMousePoint, m_pMouseEBL);
...
bool ocpn_draw_pi::CreateGZLeftClick(wxMouseEvent& event) {
  ...
  if (nGZ_State & 1) {
    ...
    DistanceBearingMercator_Plugin(
        m_cursor_lat, m_cursor_lon, g_pfFix.Lat, g_pfFix.Lon,
        &m_pMouseGZ->m_dFirstLineDirection, &m_pMouseGZ->m_dFirstDistance);
    r_rband.x = g_cursor_x;
    r_rband.y = g_cursor_y;
    m_dStartLat = rlat;
    m_dStartLon = rlon;
  ...
  if (m_pMouseGZ) {
    ...
    if (!(nGZ_State & 1)) {
      ...
      DistanceBearingMercator_Plugin(rlat, rlon, g_pfFix.Lat, g_pfFix.Lon,
                                     &m_pMouseGZ->m_dSecondLineDirection,
                                     &m_pMouseGZ->m_dSecondDistance);
      ...
      if (m_pMouseGZ->m_iPersistenceType == ID_PERSISTENT ||
          m_pMouseGZ->m_iPersistenceType == ID_PERSISTENT_CRASH) {
        if (m_pMouseGZ->m_iPersistenceType == ID_PERSISTENT_CRASH)
          m_pMouseGZ->m_bTemporary = true;
        else
          m_pMouseGZ->m_bTemporary = false;
...
bool ocpn_draw_pi::CreatePILLeftClick(wxMouseEvent& event) {
  ...
  m_pMousePIL->m_PathNameString << _("PIL") << _T(" ")
                                << g_pPILList->GetCount();
  m_dStartLat = g_pfFix.Lat;
  m_dStartLon = g_pfFix.Lon;

  ODPoint* beginPoint = new ODPoint(g_pfFix.Lat, g_pfFix.Lon,
                                    g_sPILStartIconName, _("Boat"), wxT(""));
  beginPoint->SetNameShown(false);
  ...
  DistanceBearingMercator_Plugin(rlat, rlon, m_dStartLat, m_dStartLon,
                                 &m_pMousePIL->m_dEBLAngle,
                                 &m_pMousePIL->m_dLength);

  if (m_pMousePIL->m_bRotateWithBoat) {
    switch (m_pMousePIL->m_iMaintainWith) {
      case ID_MAINTAIN_WITH_HEADING:
        if (!wxIsNaN(g_pfFix.Hdt)) m_pMousePIL->m_dEBLAngle -= g_pfFix.Hdt;
        break;
      case ID_MAINTAIN_WITH_COG:
        if (!wxIsNaN(g_pfFix.Cog)) m_pMousePIL->m_dEBLAngle -= g_pfFix.Cog;
        break;
    }
  }
  ...
  if (m_pMousePIL->m_iPersistenceType == ID_PERSISTENT ||
      m_pMousePIL->m_iPersistenceType == ID_PERSISTENT_CRASH)
    g_pODConfig->AddNewPath(m_pMousePIL, -1);  // don't save over restart
  g_pODSelect->AddSelectableODPoint(rlat, rlon, pMousePoint);
  g_pODSelect->AddSelectablePathSegment(g_pfFix.Lat, g_pfFix.Lon, rlat, rlon,
                                        beginPoint, pMousePoint, m_pMousePIL);
...
void ocpn_draw_pi::OnTimer(wxTimerEvent& ev) { ProcessTimerEvent(ev); }
...
void ocpn_draw_pi::DrawAllPathsAndODPoints(PlugIn_ViewPort& pivp) {
  for (wxPathListNode* node = g_pPathList->GetFirst(); node;
       node = node->GetNext()) {
    ODPath* pTempPath = node->GetData();
    if (!pTempPath) continue;
    if ((pTempPath->m_bIsBeingEdited || pTempPath->m_bIsBeingCreated) &&
        m_mouse_canvas_index != m_current_canvas_index) {
      continue;
    }
    ...
    //        const wxBoundingBox &vp_box = vp.GetBBox(), &test_box =
    //        pPathDraw->GetBBox();
    const LLBBox& test_box = pPathDraw->GetBBox();
    double test_miny = test_box.GetMinLat(), test_maxy = test_box.GetMaxLat();

    if (test_maxy < pivp.lat_min) continue;

    if (test_miny > pivp.lat_max) continue;
    ...
    if (pPathDraw == m_pSelectedEBL && m_bODPointEditing &&
      ...
      DistanceBearingMercator_Plugin(pEndPoint->m_lat, pEndPoint->m_lon,
                                     ...
                                     &brg, &dist);
      GetCanvasPixLL(&m_VP, &destPoint, pEndPoint->m_lat, pEndPoint->m_lon);
      GetCanvasPixLL(&m_VP, &mouse_cursor, m_cursor_lat, m_cursor_lon);
      wxString info =
      ...
      wxString info;
      wxPoint mouse_cursor;
      GetCanvasPixLL(&g_VP, &mouse_cursor, m_cursor_lat, m_cursor_lon);
      if (m_iEditMode == ID_PIL_MENU_MOVE_INDEX_LINE) {
        ...
        if (it != m_pSelectedPIL->m_PilLineList.end()) {
          info = CreateExtraPathLegInfo(dc, m_pSelectedPIL,
                                        m_pSelectedPIL->m_dEBLAngle,
                                        it->dOffset, mouse_cursor);
        }
      } else
        info = CreateExtraPathLegInfo(dc, m_pSelectedPIL,
                                      m_pSelectedPIL->m_dEBLAngle,
                                      m_pSelectedPIL->m_dLength, mouse_cursor);
  ...
  if (pivp.bValid && g_pODPointMan) {
    ...
    for (wxODPointListNode* pnode = g_pODPointMan->GetODPointList()->GetFirst();
         pnode; pnode = pnode->GetNext()) {
      ODPoint* pOP = pnode->GetData();
      if (pOP->m_bIsInPath) continue;
      if (!pOP->m_bShowODPointRangeRings ||
          (pOP->m_bShowODPointRangeRings &&
           pOP->m_iODPointRangeRingsNumber == 0)) {
...
void ocpn_draw_pi::AlphaBlending(piDC& dc, int x, int y, int size_x, int size_y,
  ...
  if (g_bShowMag) {
    if (!wxIsNaN(g_dVar)) {
      ...
      if ((a - g_UserVar) > 360.)
        ...
        return ((a - g_UserVar) >= 0.) ? (a - g_UserVar)
                                       : (a - g_UserVar + 360.);
    }
  } else
    return a;
...
void ocpn_draw_pi::SetToolbarTool(void) {
  if (nBoundary_State == 1 || nPoint_State == 1 || nTextPoint_State == 1 ||
      nEBL_State == 1 || nDR_State == 1 || nGZ_State == 1 || nPIL_State == 1) {
    ...
    switch (m_Mode) {
      ...
      case ID_MODE_EBL:
        ...
        SetToolbarToolBitmapsSVG(
            m_draw_button_id, m_pODicons->m_s_ocpn_draw_ebl,
            m_pODicons->m_s_ocpn_draw_ebl, m_pODicons->m_s_ocpn_draw_ebl_grey);
#else
        SetToolbarToolBitmaps(m_draw_button_id,
                              m_pODicons->m_p_bm_ocpn_draw_ebl_grey,
                              m_pODicons->m_p_bm_ocpn_draw_ebl);
...
#ifdef ODraw_USE_SVG
        SetToolbarToolBitmapsSVG(
            m_draw_button_id, m_pODicons->m_s_ocpn_draw_pil,
            m_pODicons->m_s_ocpn_draw_pil, m_pODicons->m_s_ocpn_draw_pil_grey);
#else
        SetToolbarToolBitmaps(m_draw_button_id,
                              m_pODicons->m_p_bm_ocpn_draw_pil_grey,
                              m_pODicons->m_p_bm_ocpn_draw_pil);
