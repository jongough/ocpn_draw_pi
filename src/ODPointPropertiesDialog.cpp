...
ODPointPropertiesDialog::ODPointPropertiesDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_panelBasicProperties = new wxScrolledWindow( m_notebookProperties, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxVSCROLL );
	...
	m_comboBoxIcon = new wxComboBox( m_panelBasicProperties, wxID_ANY, wxT("Combo!"), wxDefaultPosition, wxDefaultSize, 0, NULL, wxCB_DROPDOWN ); 
	m_SizerNameIcon->Add( m_comboBoxIcon, 0, wxALIGN_CENTER_VERTICAL|wxALL, 2 );
	...
	m_SizerPointRangeGrid = new wxFlexGridSizer( 2, 2, 0, 0 );
