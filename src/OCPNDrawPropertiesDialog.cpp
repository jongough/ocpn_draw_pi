...
OCPNDrawPropertiesDialog::OCPNDrawPropertiesDialog( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	// Connect Events
	m_buttonOK->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( OCPNDrawPropertiesDialog::OnDrawPropertiesOKClick ), NULL, this );
	m_buttonCancel->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( OCPNDrawPropertiesDialog::OnDrawPropertiesCancelClick ), NULL, this );
	m_buttonAApply->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( OCPNDrawPropertiesDialog::OnDrawPropertiesApplyClick ), NULL, this );
}

OCPNDrawPropertiesDialog::~OCPNDrawPropertiesDialog()
{
	// Disconnect Events
	m_buttonOK->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( OCPNDrawPropertiesDialog::OnDrawPropertiesOKClick ), NULL, this );
	m_buttonCancel->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( OCPNDrawPropertiesDialog::OnDrawPropertiesCancelClick ), NULL, this );
	m_buttonAApply->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( OCPNDrawPropertiesDialog::OnDrawPropertiesApplyClick ), NULL, this );
}
